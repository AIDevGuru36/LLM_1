...
def main():
  ...
  os.environ['MASTER_PORT'] = '29500'  # ✅ valid port under 65535
...
def train_and_eval(rank, n_gpus, hps):
  ...
  torch.manual_seed(hps.training.seed)
...
def save_checkpoint(generator, optimizer_g, learning_rate, epoch, path):
  (
